        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    title: 'Meet Phonecash!',
                    // (string | mandatory) the text inside the notification
                    text: 'Phonecash is a brand new online shopping solution you have always been looking for!',
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    // (string | mandatory) the heading of the notification
                    title: 'Buy On Phonecash!',
                    // (string | mandatory) the text inside the notification
                    text: 'Phonecash comes with a huge collection of items to buy. Buy on Phonecash today!',
                    // (string | optional) the image to display on the left
                    image: './assets/img/avatar1_small.jpg',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    ...
                    // (string | mandatory) the text inside the notification
                    text: 'Phonecash allows you to easily buy items online.',
                    // (string | optional) the image to display on the left
